...
(in the department coffee room) about covering the lattice \(\Z^2\) with lines.
...
The results in this note: the reformulation, the
...
interactive session. The additional references collected in the
extended-references version of this note were located and verified by Claude via
...
formalization and verification, are described in the gitlab repository \cite{gitrepo}.
